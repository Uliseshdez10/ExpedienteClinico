            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <input type="text" class="form-control" id="txt_especialidad" placeholder="Ingresar nombre..." maxlength="50" onkeypress="return soloLetras(event)">
                    </div>
                    <div class="col-lg-12">
...
<div class="modal fade" id="modal_editar" role="dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <label for="">Nombre</label>
                        <input type="text" id="txt_especialidad_actual_editar" placeholder="Ingresar nombre..." maxlength="50" onkeypress="return soloLetras(event)" hidden>
                        <input type="text" class="form-control" id="txt_especialidad_nueva_editar" placeholder="Ingresar nombre..." maxlength="50" onkeypress="return soloLetras(event)">
                    </div>
                    <div class="col-lg-12">
                    <label for="">Estatus</label>
            ...
            <div class="modal-footer">
                <button class="btn btn-primary" onclick="Modificar_Especialidad()"><i class="fa fa-check"><b>&nbsp;Editar</b></i></button>
                <button type="button" class="btn btn-danger" data-dismiss="modal"><i class="fa fa-close"><b>&nbsp;Cerrar</b></i></button>
            </div>
        </div>
        </div>
