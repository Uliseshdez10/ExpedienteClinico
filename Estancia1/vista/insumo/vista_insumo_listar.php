        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="col-lg-12">
                    ...
                    <input type="text" class="form-control" id="txt_insumo_nuevo_editar" placeholder="Ingrese insumo medico" maxlength="50" onkeypress="return soloLetras(event)" hidden><br>
                </div>
                <div class="col-lg-12">
                    <label for="">Stock</label>
