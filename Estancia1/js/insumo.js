...
function Registrar_Insumo(){
    ...
    $.ajax({
        ...
        if(resp>0){
            ...
            LimpiarCampos();
             Swal.fire("Mensaje De Advertencia","Este insumo ya esta registrado","warning");
            }
        }else{
...
function Modificar_Insumo(){
    ...
    $.ajax({
        ...
        Swal.fire("Mensaje De Error","No se pudieron actualizar los datos correctamente","error");
        }
    })
}